...
const Link = () => {
  ...
  return (
    <>
      {(loading || loadingStats) && (
        <BarLoader className="md-4" width="100%" color="#36d7b7" />
      )}
      <div className="flex flex-col gap-8 sm:flex-row justify-between">
        <div className="flex flex-col items-start gap-8 rounded-lg sm:w-2/5">
          ...
          <a
            ...
            target="_blank"
            className="items-center flex gap-1 hover:underline
          cursor-pointer"
          >
            <LinkIcon className="p-2" />
            {url?.original_url}
          </a>
        ...
        <Card className="sm:w-3/5 bg-black text-white">
          <CardHeader>
